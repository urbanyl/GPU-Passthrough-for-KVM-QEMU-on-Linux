#!/bin/bash
# setup/opensuse.sh -- Complete host setup for openSUSE Tumbleweed / Leap
# Run: sudo bash setup/opensuse.sh
set -euo pipefail

echo "============================================"
echo "  GPU Passthrough Host Setup - openSUSE"
echo "============================================"
echo ""
...
echo "  3. Add kernel parameters to /etc/default/grub"
